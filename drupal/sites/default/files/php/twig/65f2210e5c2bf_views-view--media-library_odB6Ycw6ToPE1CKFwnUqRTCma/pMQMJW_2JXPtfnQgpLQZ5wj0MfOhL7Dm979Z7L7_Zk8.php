...
class __TwigTemplate_702574e96a1fc2ab6ebee7a9573f2573 extends Template
{
    private $source;
    private $macros = [];
...
($context["dom_id"] ?? null)) ? (("js-view-dom-id-" . $this->sandbox->ensureToStringAllowed(($context["dom_id"] ?? null), 41, $this->source))) : (""))];
  ...
  ";
      ...
      ";
            // line 57
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["header"] ?? null), 57, $this->source), "html", null, true);
            echo "
    </div>
  ";
        }
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["id", "display_id", "dom_id", "attributes", "title_prefix", "title", "title_suffix", "exposed", "header", "attachment_before", "rows", "empty", "pager", "attachment_after", "more", "footer", "feed_icons"]);    }
    ...
    {
        return new Source("", "core/themes/claro/templates/media-library/views-view--media-library.html.twig", "/app/drupal/core/themes/claro/templates/media-library/views-view--media-library.html.twig");
    }
