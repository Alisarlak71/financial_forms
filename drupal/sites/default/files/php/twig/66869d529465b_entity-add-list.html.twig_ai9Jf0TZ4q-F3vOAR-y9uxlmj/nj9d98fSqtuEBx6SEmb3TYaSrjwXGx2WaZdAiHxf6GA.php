...
class __TwigTemplate_8444c292fc1c3fcc0a6c6f6712f64a8c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div";
            // line 29
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["admin-list", "panel__content", "gin-layer-wrapper"], "method", false, false, true, 29), 29, $this->source), "html", null, true);
            echo ">
      ";
            // line 30
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["bundle"]) {
                ...
                // line 35
                echo "        ";
                $context["bundle_attributes"] = ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["bundle"], "add_link", [], "any", false, false, true, 35), "url", [], "any", false, false, true, 35), "getOption", ["attributes"], "method", false, false, true, 35)) ?: ([]));
                // line 36
                echo "        ";
                $context["link_attributes"] = twig_get_attribute($this->env, $this->source, $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute($this->sandbox->ensureToStringAllowed(($context["bundle_attributes"] ?? null), 36, $this->source)), "addClass", ["admin-item__link"], "method", false, false, true, 36);
                // line 37
                echo "        ";
...
";
        ...
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["bundles", "title", "attributes", "add_bundle_message"]);    }
    ...
    {
        return new Source("", "@gin/admin/entity-add-list.html.twig", "/app/drupal/themes/contrib/gin/templates/admin/entity-add-list.html.twig");
    }
