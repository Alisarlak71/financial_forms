...
class __TwigTemplate_4e0acc705d080445eb2e5e4177d16e8c extends Template
{
    private $source;
    private $macros = [];
...
($context["dom_id"] ?? null)) ? (("js-view-dom-id-" . $this->sandbox->ensureToStringAllowed(($context["dom_id"] ?? null), 39, $this->source))) : (""))];
  ...
  ";
        ...
        if (($context["rows"] ?? null)) {
            // line 65
            echo "    <div class=\"view-content gin-layer-wrapper\">
      ";
            // line 66
...
";
    ...
    {
        return new Source("", "themes/contrib/gin/templates/views/views-view.html.twig", "/app/drupal/themes/contrib/gin/templates/views/views-view.html.twig");
    }
